...
# Base English data with ALL keys
en_data = {
  "common": {
    "login": "Login",
    "signup": "Sign Up",
...
print("Generating translations for all languages...")
for lang_code, google_code in lang_map.items():
    print(f"Translating {lang_code} ({google_code})...")
    translated_data = translate_dict(en_data, google_code)
